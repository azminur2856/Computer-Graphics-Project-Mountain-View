...
void fireAnimation()
{
    ...
    P1[0].first -= 1.5 * f1;//5 * f1;
    P2[0].first -= 1.5 * f1;//5 * f1;
    P1[1].first += 1.5 * f1;//5 * f2;
    P2[1].first += 1.5 * f1;//5 * f2;
}
...
void changeView(int value) {
    ...
    currentView = array[a];
    glutPostRedisplay();
    glutTimerFunc(5000, changeView, 0); // Call this function again after 10 seconds
}
...
int main(int argc, char **argv)
{
    ...
    glutTimerFunc(5000, changeView, 0); // Start the timer for changing views
    glutMainLoop();
}
